...
engine.setProperty('rate', 160)  # Adjust speech rate here
...
def takecommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            speak("anything else I can help you with, Mr. Pulkit?")
            return "none"
    ...
    try:
        ...
        speak("Mister Pulkit, I don't understand that")
        return "none"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "Godrej" in query:
            ...
            webbrowser.open("https://www.linkedin.com/in/pulkit-agarwal-143557232/")
            ...
            try:
                ...
                speak("Email has been sent to Pulkit")
            except Exception as e:
                print(e)
            ...
            email = 'pulkitagarwal2020@gmail.com'  # your mail id
